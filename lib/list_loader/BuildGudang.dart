...
class _BuildgudangState extends State<Buildgudang> {
  ...
  final BTree _productBTree = BTree(3); // Degree of the tree
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        for (var product in products) {
          final lowerCaseName = product['nama_barang'].toLowerCase(); // Convert product name to lowercase
  ...
  void _searchProducts(String query) {
    ...
    final matchedProducts = _productBTree.searchBySubstring(lowerCaseQuery); // Use substring search
    setState(() {
      _filteredProducts = matchedProducts.toSet().toList(); // Remove duplicates if any
    });
  }
